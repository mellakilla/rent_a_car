...
class Customer:
    ...
    def returnVehicle(self,brand):
        ...
        """
        if brand == "cars":
            if self.retalTime_c and self.rentalBasis_c and self.cars:
                return self.retalTime_b, self.rentalBasis_b, self.cars
            else:
                return 0,0,0
        elif brand == "bikes":
            if self.retalTime_b and self.rentalBasis_b and self.bikes:
                return self.retalTime_b, self.rentalBasis_b, self.bikes
            else:
                return 0,0,0  
        else:
            print("Request vehicle error")
